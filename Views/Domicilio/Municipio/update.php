        ...
        <div class="main">
            ...
            <form class="formulario" method="POST">
                ...
                <div class="secc-form-2">
                    ...
                    <input type="text" autocomplete="off" class="input-form" id="validationCustom02" value="<?= $_GET['descripcion'] ?>" required name="municipio">

                </div>

                <button type="submit" class="bttn" class="tittle" name="actualizar" value="ok">Actualizar</button>
            ...
            <?php
                ...
                if (isset($_POST['actualizar'])) {
                    $resultado = MunicipioModel::update();

                    if ($resultado) {
                        echo "<script>window.alert('El municipio se ha actualizado exitosamente')</script>";
                        echo "<script>window.location.replace('/Funeraria/Views/Domicilio/Municipio/index.php')</script>";
                    } else {
                        echo "<script>window.alert('El municipio no pudo ser actualizado, verifique que los datos sean correctos e inténtelo nuevamente')</script>";
                    }
                }
            ?>
        </div>
