...
<section class="home">
    ...
    <div class="agregarbttn">
        <a href="/Funeraria/Views/Datos_Maestros/Cementerios/create.php"><button type="button" class="bttn" class="tittle">Agregar</button></a>
    </div>
    
    <div class="main">

        <h2 class="title-h2">Información Cementerios</h2>
        ...
        <div class="conta">
            <div class="container my-5">
                ...
                <table id="datatable" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        include($_SERVER['DOCUMENT_ROOT'] . "/Funeraria/Models/Maestro_Models/CementerioModel.php");
                        ...
                        foreach ($cementerios as $cementerio) { ?>
                            ...
                            <tr>
                                <td><?= $cementerio["rif_juridico"] ?></td>
                                <td><?= $cementerio["tipo"] ?></td>
                                <td class="text-center">
                                    <a href="/Funeraria/Views/Domicilio/Estado/update.php?codigo=<?= $estado["codigo"] ?>&descripcion=<?= $estado["descripcion"] ?>"><button type="button" class="btn btn-warning mr-2"><i class="fa-solid fa-pen-to-square"></i></button></a>
