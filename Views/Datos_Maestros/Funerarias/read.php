...
<section class="home">
    ...
    <div class="agregarbttn">
        <a href="/Funeraria/Views/Datos_Maestros/Funerarias/create.php"><button type="button" class="bttn" class="tittle">Agregar</button></a>
    </div>
    
    <div class="main">

        <h2 class="title-h2">Información Funerarias</h2>
        ...
        <div class="conta">
            <div class="container my-5">
                ...
                <table id="datatable" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        include($_SERVER['DOCUMENT_ROOT'] . "/Funeraria/Models/Maestro_Models/FunerariaModel.php");

                        $Funerarias = FunerariaModel::read();

                        foreach ($Funerarias as $funeraria) { ?>

                            <tr>
                                <td><?= $funeraria["rif_juridico"] ?></td>
                                <td><?= $funeraria["tipo"] ?></td>
                                <td class="text-center">
                                    <a href="/Funeraria/Views/Datos_Maestros/Funerarias/update.php"><button type="button" class="btn btn-warning mr-2"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                    <a href="/Funeraria/Views/Datos_Maestros/Funerarias/index.php" onclick="return eliminarEstado()"> <button type="button" name="eliminar" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
