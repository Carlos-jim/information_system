...
-- -----------------------------------------------------
-- Table `DER`.`domicilio_estado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`domicilio_estado` (
  `codigo` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `DER`.`domicilio_municipio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`domicilio_municipio` (
  `codigo` INT NOT NULL,
  `descripcion` VARCHAR(100) NOT NULL,
  `estado_codigo` INT NOT NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_domicilio_municipio_domicilio_estado1_idx` (`estado_codigo` ASC),
  CONSTRAINT `fk_domicilio_municipio_domicilio_estado1`
    FOREIGN KEY (`estado_codigo`)
    REFERENCES `DER`.`domicilio_estado` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DER`.`domicilio_parroquia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`domicilio_parroquia` (
  `codigo` INT NOT NULL,
  `descripcion` VARCHAR(100) NOT NULL,
  `municipio_codigo` INT NOT NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_domicilio_parroquia_domicilio_municipio1_idx` (`municipio_codigo` ASC),
  CONSTRAINT `fk_domicilio_parroquia_domicilio_municipio1`
    FOREIGN KEY (`municipio_codigo`)
    REFERENCES `DER`.`domicilio_municipio` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DER`.`domicilio_ciudad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`domicilio_ciudad` (
  `codigo` INT NOT NULL,
  `descripcion` VARCHAR(100) NOT NULL,
  `parroquia_codigo` INT NOT NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_domicilio_ciudad_domicilio_parroquia1_idx` (`parroquia_codigo` ASC),
  CONSTRAINT `fk_domicilio_ciudad_domicilio_parroquia1`
    FOREIGN KEY (`parroquia_codigo`)
    REFERENCES `DER`.`domicilio_parroquia` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DER`.`persona_natural`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`persona_natural` (
  ...
  UNIQUE INDEX `cedula_id_UNIQUE` (`cedula_id` ASC),
  INDEX `fk_persona_natural_domicilio_ciudad1_idx` (`ciudad_codigo` ASC),
  CONSTRAINT `fk_persona_natural_domicilio_ciudad1`
    FOREIGN KEY (`ciudad_codigo`)
    REFERENCES `DER`.`domicilio_ciudad` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DER`.`persona_juridica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`persona_juridica` (
  `rif` VARCHAR(10) NOT NULL,
  `razon_social` VARCHAR(45) NOT NULL,
  `ciudad_codigo` INT NOT NULL,
  PRIMARY KEY (`rif`),
  UNIQUE INDEX `rif_UNIQUE` (`rif` ASC),
  INDEX `fk_persona_juridica_domicilio_ciudad1_idx` (`ciudad_codigo` ASC),
  CONSTRAINT `fk_persona_juridica_domicilio_ciudad1`
    FOREIGN KEY (`ciudad_codigo`)
    REFERENCES `DER`.`domicilio_ciudad` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DER`.`cementerio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`cementerio` (
  `tipo` VARCHAR(50) NOT NULL,
  `rif_juridico` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`rif_juridico`),
  CONSTRAINT `fk_cementerio_persona_juridica1`
    FOREIGN KEY (`rif_juridico`)
    REFERENCES `DER`.`persona_juridica` (`rif`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `DER`.`difunto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`difunto` (
  `codigo` INT NOT NULL,
  `causa_muerte` VARCHAR(100) NOT NULL,
  `lugar_muerte` VARCHAR(250) NOT NULL,
  `fecha_muerte` DATE NOT NULL,
  `fecha_nacimiento` DATE NOT NULL,
  `cedula_natural` VARCHAR(9) NOT NULL,
  `cementerio_rif_juridico` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`cedula_natural`),
  INDEX `fk_difunto_cementerio1_idx` (`cementerio_rif_juridico` ASC),
  CONSTRAINT `fk_difunto_persona_natural1`
    FOREIGN KEY (`cedula_natural`)
    REFERENCES `DER`.`persona_natural` (`cedula_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_difunto_cementerio1`
    FOREIGN KEY (`cementerio_rif_juridico`)
    REFERENCES `DER`.`cementerio` (`rif_juridico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `DER`.`funeraria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`funeraria` (
  `tipo` VARCHAR(50) NOT NULL,
  `rif_juridico` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`rif_juridico`),
  CONSTRAINT `fk_funeraria_persona_juridica1`
    FOREIGN KEY (`rif_juridico`)
    REFERENCES `DER`.`persona_juridica` (`rif`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `DER`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`usuario` (
  `no_identificacion` INT NOT NULL,
  `login` VARCHAR(20) NOT NULL,
  `password` VARCHAR(20) NOT NULL,
  `cedula_natural` VARCHAR(9) NOT NULL,
  `funeraria_rif_juridico` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`cedula_natural`),
  INDEX `fk_usuario_funeraria1_idx` (`funeraria_rif_juridico` ASC),
  CONSTRAINT `fk_usuario_persona_natural1`
    FOREIGN KEY (`cedula_natural`)
    REFERENCES `DER`.`persona_natural` (`cedula_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_funeraria1`
    FOREIGN KEY (`funeraria_rif_juridico`)
    REFERENCES `DER`.`funeraria` (`rif_juridico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DER`.`servicio_prestado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`servicio_prestado` (
  `codigo` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `DER`.`polizas_seguro_funerario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`polizas_seguro_funerario` (
  `numero` INT NOT NULL AUTO_INCREMENT,
  `fecha_apertura` DATETIME NULL,
  `fecha_vencimiento` DATETIME NULL,
  `cuota_anual` DECIMAL(7) NULL,
  `cuota_mensual` DECIMAL(7) NULL,
...
-- -----------------------------------------------------
-- Table `DER`.`pago_mensual`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`pago_mensual` (
  `numero` INT NOT NULL,
  `fecha` DATETIME NULL,
  `monto` DECIMAL(7) NULL,
  `poliza_funerario_numero` INT NOT NULL,
  `us_cedula_natural` VARCHAR(9) NOT NULL,
  PRIMARY KEY (`numero`, `poliza_funerario_numero`),
  UNIQUE INDEX `Numero_UNIQUE` (`numero` ASC),
  INDEX `fk_Recibos de Pago Mensual_Polizas de Seguro funerario1_idx` (`poliza_funerario_numero` ASC),
  INDEX `fk_Recibos de Pago Mensual_usuario1_idx` (`us_cedula_natural` ASC),
  CONSTRAINT `fk_Recibos de Pago Mensual_Polizas de Seguro funerario1`
    FOREIGN KEY (`poliza_funerario_numero`)
    REFERENCES `DER`.`polizas_seguro_funerario` (`numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Recibos de Pago Mensual_usuario1`
    FOREIGN KEY (`us_cedula_natural`)
    REFERENCES `DER`.`usuario` (`cedula_natural`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DER`.`cliente_natural`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`cliente_natural` (
  `cedula_natural` VARCHAR(9) NOT NULL,
  PRIMARY KEY (`cedula_natural`),
  CONSTRAINT `fk_cliente natural_persona_natural1`
    FOREIGN KEY (`cedula_natural`)
    REFERENCES `DER`.`persona_natural` (`cedula_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DER`.`cliente_juridico`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`cliente_juridico` (
  `direccion` VARCHAR(45) NOT NULL,
  `correo` VARCHAR(45) NULL,
  `telefono` VARCHAR(45) NULL,
  `rif_juridico` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`rif_juridico`),
  CONSTRAINT `fk_cliente juridico_persona_juridica1`
    FOREIGN KEY (`rif_juridico`)
    REFERENCES `DER`.`persona_juridica` (`rif`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DER`.`factura_anual`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`factura_anual` (
  `numero` INT NOT NULL,
  `fecha` DATETIME NULL,
  `monto` DECIMAL(7) NULL,
  `poliza _funerario_numero` INT NOT NULL,
  `us_cedula_natural` VARCHAR(9) NOT NULL,
  PRIMARY KEY (`numero`, `poliza _funerario_numero`),
  UNIQUE INDEX `Numero_UNIQUE` (`numero` ASC),
  INDEX `fk_Recibos de Pago Mensual_Polizas de Seguro funerario1_idx` (`poliza _funerario_numero` ASC),
  INDEX `fk_factura_anual_usuario1_idx` (`us_cedula_natural` ASC),
  CONSTRAINT `fk_Recibos de Pago Mensual_Polizas de Seguro funerario10`
    FOREIGN KEY (`poliza _funerario_numero`)
    REFERENCES `DER`.`polizas_seguro_funerario` (`numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_factura_anual_usuario1`
    FOREIGN KEY (`us_cedula_natural`)
    REFERENCES `DER`.`usuario` (`cedula_natural`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DER`.`funeraria_has_servicio_prestado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`funeraria_has_servicio_prestado` (
  `funeraria_rif_juridico` VARCHAR(10) NOT NULL,
  `servicio_prestado_codigo` INT NOT NULL,
  `monto` DECIMAL(7) NULL,
  PRIMARY KEY (`funeraria_rif_juridico`, `servicio_prestado_codigo`),
  INDEX `fk_funeraria_has_Servicios Prestados_Servicios Prestados1_idx` (`servicio_prestado_codigo` ASC),
  INDEX `fk_funeraria_has_Servicios Prestados_funeraria1_idx` (`funeraria_rif_juridico` ASC),
  CONSTRAINT `fk_funeraria_has_Servicios Prestados_funeraria1`
    FOREIGN KEY (`funeraria_rif_juridico`)
    REFERENCES `DER`.`funeraria` (`rif_juridico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_funeraria_has_Servicios Prestados_Servicios Prestados1`
    FOREIGN KEY (`servicio_prestado_codigo`)
    REFERENCES `DER`.`servicio_prestado` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DER`.`servicios_por_poliza`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`servicios_por_poliza` (
  `poliza_funerario_numero` INT NOT NULL,
  `funeraria_rif_juridico` VARCHAR(10) NOT NULL,
  `servicios_prestado_codigo` INT NOT NULL,
  PRIMARY KEY (`poliza_funerario_numero`, `funeraria_rif_juridico`, `servicios_prestado_codigo`),
  INDEX `fk_Polizas de Seguro funerario_has_funeraria_has_Servicios _idx` (`funeraria_rif_juridico` ASC, `servicios_prestado_codigo` ASC),
  INDEX `fk_Polizas de Seguro funerario_has_funeraria_has_Servicios _idx1` (`poliza_funerario_numero` ASC),
  CONSTRAINT `fk_Polizas de Seguro funerario_has_funeraria_has_Servicios Pr1`
    FOREIGN KEY (`poliza_funerario_numero`)
    REFERENCES `DER`.`polizas_seguro_funerario` (`numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Polizas de Seguro funerario_has_funeraria_has_Servicios Pr2`
    FOREIGN KEY (`funeraria_rif_juridico` , `servicios_prestado_codigo`)
    REFERENCES `DER`.`funeraria_has_servicio_prestado` (`funeraria_rif_juridico` , `servicio_prestado_codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DER`.`polizas_naturales`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`polizas_naturales` (
  `cedula_natural` VARCHAR(9) NOT NULL,
  `polizas_funerario_numero` INT NOT NULL,
  PRIMARY KEY (`cedula_natural`, `polizas_funerario_numero`),
  INDEX `fk_cliente natural_has_Polizas de Seguro funerario_Polizas _idx` (`polizas_funerario_numero` ASC),
  INDEX `fk_cliente natural_has_Polizas de Seguro funerario_cliente _idx` (`cedula_natural` ASC),
  UNIQUE INDEX `Polizas de Seguro funerario_Numero_UNIQUE` (`polizas_funerario_numero` ASC),
  CONSTRAINT `fk_cliente natural_has_Polizas de Seguro funerario_cliente na1`
    FOREIGN KEY (`cedula_natural`)
    REFERENCES `DER`.`cliente_natural` (`cedula_natural`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cliente natural_has_Polizas de Seguro funerario_Polizas de1`
    FOREIGN KEY (`polizas_funerario_numero`)
    REFERENCES `DER`.`polizas_seguro_funerario` (`numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DER`.`polizas_juridicas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`polizas_juridicas` (
  `cliente_rif_juridico` VARCHAR(10) NOT NULL,
  `poliza_funerario_numero` INT NOT NULL,
  PRIMARY KEY (`cliente_rif_juridico`, `poliza_funerario_numero`),
  INDEX `fk_cliente juridico_has_Polizas de Seguro funerario_Polizas_idx` (`poliza_funerario_numero` ASC),
  INDEX `fk_cliente juridico_has_Polizas de Seguro funerario_cliente_idx` (`cliente_rif_juridico` ASC),
  UNIQUE INDEX `poliza_funerario_numero_UNIQUE` (`poliza_funerario_numero` ASC),
  CONSTRAINT `fk_cliente juridico_has_Polizas de Seguro funerario_cliente j1`
    FOREIGN KEY (`cliente_rif_juridico`)
    REFERENCES `DER`.`cliente_juridico` (`rif_juridico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cliente juridico_has_Polizas de Seguro funerario_Polizas d1`
    FOREIGN KEY (`poliza_funerario_numero`)
    REFERENCES `DER`.`polizas_seguro_funerario` (`numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DER`.`difuntos_con_poliza`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DER`.`difuntos_con_poliza` (
  `difunto_cedula_natural` VARCHAR(9) NOT NULL,
  `numero_poliza` INT NOT NULL,
  PRIMARY KEY (`difunto_cedula_natural`, `numero_poliza`),
  INDEX `fk_difunto_has_polizas_seguro_funerario_polizas_seguro_fune_idx` (`numero_poliza` ASC),
  INDEX `fk_difunto_has_polizas_seguro_funerario_difunto1_idx` (`difunto_cedula_natural` ASC),
  UNIQUE INDEX `difunto_cedula_natural_UNIQUE` (`difunto_cedula_natural` ASC),
  CONSTRAINT `fk_difunto_has_polizas_seguro_funerario_difunto1`
    FOREIGN KEY (`difunto_cedula_natural`)
    REFERENCES `DER`.`difunto` (`cedula_natural`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_difunto_has_polizas_seguro_funerario_polizas_seguro_funera1`
...
INSERT INTO `domicilio_estado` (`codigo`, `descripcion`) VALUES
(1, 'Amazonas'),
(2, 'Anzoátegui'),
(3, 'Apure'),
(4, 'Aragua'),
...
INSERT INTO `domicilio_municipio` (`codigo`, `estado_codigo`, `descripcion`) VALUES
(1, 1, 'Alto Orinoco'),
(2, 1, 'Atabapo'),
(3, 1, 'Atures'),
(4, 1, 'Autana'),
...
INSERT INTO `domicilio_parroquia` (`codigo`, `municipio_codigo`, `descripcion`) VALUES
(1, 1, 'Alto Orinoco'),
...
INSERT INTO `domicilio_ciudad` (`codigo`, `parroquia_codigo`, `descripcion`) VALUES
(1, 1, 'Alto Orinoco');

INSERT INTO `persona_natural` (`cedula_id`,`nombre`, `apellido`, `direccion`, `telefono`, `correo`, `ciudad_codigo`) VALUES
('30303030','Celis','Calis','Los Coconuts','04128889507','celis@gmail.cum',1),
('30303031','Boris','Calis','Los Coconuts','04128889508','boris@gmail.cum',1),
('30303033','Moris','Calis','Los Coconuts','04128889509','moris@gmail.cum',1),
('30303034','Morod','Calis','Los Coconuts','04128889510','morod@gmail.cum',1);

INSERT INTO `persona_juridica` (`rif`,`razon_social`,`ciudad_codigo`) VALUES
('1234567890','Funeraria Hogar',1),
('1234567891','Ferreteria lococo',1);

INSERT INTO `funeraria` (`tipo`,`rif_juridico`) VALUES
('Privada','1234567890');

INSERT `usuario` (`no_identificacion`, `login`, `password`, `cedula_natural`, `funeraria_rif_juridico`) VALUES
(1,'celis','12345678','30303030','1234567890');

INSERT INTO `cementerio` (`tipo`, `rif_juridico`) VALUES 
('Publico', '1234567890');

INSERT INTO `difunto` (`codigo`, `causa_muerte`, `lugar_muerte`, `fecha_muerte`, `fecha_nacimiento`, `cedula_natural`, `cementerio_rif_juridico`) VALUES 
(1, 'Atragantamiento', 'Los Coconuts', '2022-09-11', '1978-09-11', '30303033', '1234567890'),
(2, 'Escuchando Morat', 'Los Coconuts', '2022-09-11', '1998-09-11', '30303034', '1234567890');

INSERT INTO `cliente_juridico` (`direccion`, `correo`, `telefono`, `rif_juridico`) VALUES 
('Los Coconuts', 'ferreram@gmail.cum','04127778888', '1234567891');

INSERT INTO `cliente_natural` (`cedula_natural`) VALUES 
('30303031');

INSERT INTO `servicio_prestado` (`codigo`, `nombre`) VALUES 
(121, 'Carro Fúnebre'), 
(122, 'Sillas y Servicio en Casa'), 
(123, 'Urna'), 
(124, 'Capilla'),
(125, 'Cremación'), 
(126, 'Oficio de Misa'), 
(127, 'Traslado Local'), 
(128, 'Traslado Nacional'), 
(129, 'Traslado Internacional'), 
(130, 'Preparación del Difunto 24H');

INSERT INTO `funeraria_has_servicio_prestado` (`funeraria_rif_juridico`, `servicio_prestado_codigo`, `monto`) VALUES 
('1234567890', 121, 4000.0);

INSERT INTO `polizas_seguro_funerario` (`numero`, `fecha_apertura`, `fecha_vencimiento`, `cuota_anual`, `cuota_mensual`, `observaciones`) VALUES 
(1, '2023-03-21', '2023-04-21', 120.00, 10.00, 'Es una poliza :)');

INSERT INTO `difuntos_con_poliza` (`difunto_cedula_natural`, `numero_poliza`) VALUES 
('30303034', 1);

INSERT INTO `polizas_naturales` (`cedula_natural`, `polizas_funerario_numero`) VALUES 
('30303031', 1);

INSERT INTO `polizas_juridicas` (`cliente_rif_juridico`, `poliza_funerario_numero`) VALUES 
('1234567891', 1);

INSERT INTO `factura_anual` (`numero`, `fecha`, `monto`, `poliza _funerario_numero`, `us_cedula_natural`) VALUES 
(1, '2023-01-01', 120.00, 1, '30303030');

INSERT INTO `pago_mensual` (`numero`, `fecha`, `monto`, `poliza_funerario_numero`, `us_cedula_natural`) VALUES 
(1, '2023-02-01', 10.0, 1, '30303030');

INSERT INTO `servicios_por_poliza` (`poliza_funerario_numero`, `funeraria_rif_juridico`, `servicios_prestado_codigo`) VALUES 
(1, '1234567890', 121);
